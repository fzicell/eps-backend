...
public class ParkingController {
    ...
    public Parking getMyParkings(@RequestParam(value="name", defaultValue="World") String name) {
        return new Parking(counter.incrementAndGet(),
    ...
    public Parking startParking(@RequestParam(value="name", defaultValue="World") String name) {
        return new Parking(counter.incrementAndGet(),
                            String.format(template, name));
    }
    ...
    public Parking stopParking(@RequestParam(value="name", defaultValue="World") String name) {
        return new Parking(counter.incrementAndGet(),
                            String.format(template, name));
    }
}
